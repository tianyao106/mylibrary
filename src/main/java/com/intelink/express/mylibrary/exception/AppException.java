package com.intelink.express.mylibrary.exception;
...
public class AppException extends Exception implements UncaughtExceptionHandler {
	...
	private static final long serialVersionUID = 8242652112442659252L;
	...
	private String saveCrashInfo2File(Throwable ex) {
		...
		try {
			...
			if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
				String path =Environment.getExternalStorageDirectory().getAbsolutePath()+ "/logcat/"+new SimpleDateFormat("yyyy-MM-dd").format(new Date())+"/";
